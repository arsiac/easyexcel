...
public class ExcelAnalyserImpl implements ExcelAnalyser {
    ...
    private BaseSaxAnalyser getSaxAnalyser() {
        if (saxAnalyser == null) {
            if (ExcelType.XLS.equals(analysisContext.getExcelType())) {
    ...
    public void init(InputStream inputStream, ExcelType excelType, Object custom,
                     AnalysisEventListener eventListener, boolean trim) {
        analysisContext = new AnalysisContextImpl(inputStream, excelType, custom,
            eventListener, trim);
    }
