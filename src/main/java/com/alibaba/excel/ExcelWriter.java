...
public class ExcelWriter {
     ...
     */
    public ExcelWriter(OutputStream outputStream, ExcelType typeEnum) {
     ...
     */
    public ExcelWriter(OutputStream outputStream, ExcelType typeEnum, boolean needHead) {
     ...
     * @return this（当前引用）
     */
    public ExcelWriter write(List<? extends ExcelRowModel> data, Sheet sheet) {
     ...
     * @return this（当前引用）
     */
    public ExcelWriter write(List<? extends ExcelRowModel> data, Sheet sheet, Table table) {
